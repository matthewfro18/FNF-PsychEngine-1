...
class Controls
{
	...
	private function get_UI_UP() return justPressed('ui_up');
	private function get_UI_DOWN() return justPressed('ui_down');
	private function get_UI_LEFT() return justPressed('ui_left');
	private function get_UI_RIGHT() return justPressed('ui_right');
